...
//
// ASCOM Telescope driver for TrackTheStars
//
...
namespace ASCOM.TrackTheStars.Telescope
{
    //
    ...
    //
    // Your driver's DeviceID is ASCOM.TrackTheStars.Telescope
    //
    // The COM Guid attribute sets the CLSID for ASCOM.TrackTheStars.Telescope
    // The COM ClassInterface/None attribute prevents an empty interface called _TrackTheStars from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("83e6b083-206d-4d17-ae31-949623783aa6")]
    [ProgId("ASCOM.TrackTheStars.Telescope")]
    [ServedClassName("ASCOM Telescope Driver for TrackTheStars")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Telescope : ReferenceCountedObjectBase, ITelescopeV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackTheStars"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Telescope()
        {
            try
            {
                ...
                tl = new TraceLogger("", "TrackTheStars.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.TrackTheStars.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
